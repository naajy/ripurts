...
if b == "account":
    ...
    if f =="1":
        ...
        print(Fore.BLUE + '')
        q = requests.get("https://raw.githubusercontent.com/naajy/for/main/README.md").text
        print(q)
        print(Fore.GREEN)
        print ("____________________")
        print(Fore.YELLOW + '')
...
if b == "group":
    ...
    time.sleep(1)
    print(Fore.RED + '')
    i = requests.get("https://raw.githubusercontent.com/naajy/req/main/README.md").text
    print (i)
    print(Fore.BLUE +'')
    print("_______________________")
    print()
